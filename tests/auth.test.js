...
describe('Authentication API', () => {
  ...
  describe('POST /api/auth/register', () => {
    ...
    it('should not register user with weak password', async () => {
      const weakPasswordUser = { ...testUser, email: 'test2@example.com', password: '123' };
    ...
    it('should not register user with existing email', async () => {
      ...
      expect(response.body).to.have.property('success', false);
      expect(response.body).to.have.property('message', 'User already exists with this email');
    });
  });
  ...
  describe('GET /api/auth/profile', () => {
    ...
    it('should not get profile without token', async () => {
      ...
      expect(response.body).to.have.property('success', false);
      expect(response.body).to.have.property('message', 'Access token required');
    });
